...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = '#2AABEE', // Telegram Blue
  gradientTo = '#25D366',   // WhatsApp Green
  glowColor = 'rgba(42, 171, 238, 0.4)',   // Soft blue glow for light mode
  ...rest
}: DotFieldProps) => {
  ...
  useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent) {
      ...
      // Use clientX/Y so it tracks correctly even if the canvas is fixed position
