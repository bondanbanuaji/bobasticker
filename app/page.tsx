    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <p className="animate-fade-in-up-delay-2 mt-6 max-w-xl text-lg text-white/50 sm:text-xl">
          Kirim foto ke bot → terima stiker{" "}
        ...
        <div className="animate-fade-in-up-delay-3 mt-10 flex flex-col items-center gap-4 sm:flex-row">
          <a
            ...
            className="group relative inline-flex items-center gap-3 overflow-hidden rounded-xl bg-gradient-to-r from-[#6c5ce7] to-[#00cec9] px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(108,92,231,0.4)]"
          >
            <svg
            ...
            {[
              {
                ...
                emoji: "📸",
                title: "Kirim Foto",
                desc: "Buka bot di Telegram, kirim foto apa saja dari galeri atau kamera kamu.",
              },
              {
                step: "02",
                emoji: "⚡",
