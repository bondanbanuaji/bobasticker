...
export default function Home() {
  ...
  const showToast = (message: string) => {
    ...
    // Trigger exit animation after 4.5 seconds
    setTimeout(() => {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Sihir foto jadi stiker Telegram & WhatsApp dalam hitungan detik. 100% gratis, tanpa login, sat-set langsung jadi.",
            "offers": {
              "@type": "Offer",
              "price": "0",
              "priceCurrency": "IDR"
              ...
              <div className="flex-1 animate-fade-in opacity-0">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Balasnya kilat banget, di bawah 1 detik (jauh lebih cepet dari balasan crush lo).</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-green-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                  ...
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-green-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                    <span className="text-gray-700">Gak ada kata ngantri. Lo prioritas utama kita, bukan sekadar opsi.</span>
                  </li>
                </ul>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-end gap-2">
              <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-2 flex items-center gap-2">
                ...
                >
                  <img src="/images/boba.jpg" alt="Boba" className="w-6 h-6 rounded-full object-cover border border-gray-200 shadow-sm transition-all group-hover:ring-2 group-hover:ring-[var(--color-telegram)] group-hover:ring-offset-2" />
                </a>
              </p>
